...
$public_logchannel = '@DakalPvSaz'; // ایدی کانال عمومی که ربات اصلی در ان ادمین است برای بخش تبلیغات
...
##----------------------اطلاعات دیتابیس
$DB_HOST = 'localhost';
$DB_NAME = 'dakallli_Diar'; // نام دیتابیس
$DB_USERNAME = 'dakallli_Diar';  //یوزرینم برای اتصال به دیتابیس
$DB_PASSWORD = 'hosyarww1234'; // پسورد برای اتصال به دیتابیس
##----------------------##
