...
elseif ($text == "🌈 ثبت تبلیغ") {
	...
	sendMessage($chat_id, "👇🏻 برای ثبت تبلیغات خود برای نمایش در ربات های ساخته شده توسط این سرویس به ایدی زیر مراجعه نمایید.", 'markdown', $message_id, $inline_keyboard);
}
##----------------------
