...
if (isset($update->edited_message)) {
	...
	$forward = isset($message->forward_from) ? $message->forward_from : '';
	$forward_id = isset($message->forward_from->id) ? $message->forward_from->id : '';
	$sticker_id = isset($message->sticker->file_id) ? $message->sticker->file_id : '';
	$video_id = isset($message->video->file_id) ? $message->video->file_id : '';
	$voice_id = isset($message->voice->file_id) ? $message->voice->file_id : '';
	$file_id = isset($message->document->file_id) ? $message->document->file_id : '';
	$music_id = isset($message->audio->file_id) ? $message->audio->file_id : '';
	$photo0_id = isset($message->photo[0]->file_id) ? $message->photo[0]->file_id : '';
	$photo1_id = isset($message->photo[1]->file_id) ? $message->photo[1]->file_id : '';
	$photo2_id = isset($message->photo[2]->file_id) ? $message->photo[2]->file_id : '';
...
[['text'=>'🥺 یه وقت زشت نباشه!'],['text'=>'😄 فک و فامیله داریم؟']],
